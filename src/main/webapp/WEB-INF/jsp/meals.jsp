...
<div class="jumbotron pt-4">
    <div class="container">
        ...
        <div class="card-footer text-right">
            <button type="button" class="btn btn-danger" id="clearFilter"><spring:message code="common.cancel"/></button>
            <button type="submit" class="btn btn-primary" id="applyFilter"><spring:message code="meal.filter"/></button>
        </div>
        <br/>
        ...
        <table class="table table-striped" id="datatable">
            ...
            <c:forEach items="${meals}" var="meal">
                ...
                <tr data-mealExcess="${meal.excess}" id="${meal.id}">
                    ...
                    <td>${meal.calories}</td>
                    <td>
                        <a title="<spring:message code="common.update"/>">
